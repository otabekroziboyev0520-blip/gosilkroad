...
function PlanPage({ onBack }) {
  ...
  const ITINERARIES = {
    culture: {
      ...
      routes: {
        7: [
          "Day 1–2: Tashkent — Metro tour, Chorsu Bazaar, Hazrat Imam",
          "Day 3–4: Samarkand — Registan, Shah-i-Zinda, Gur-i Amir",
          "Day 5–6: Bukhara — Kalon Minaret, Ark, Lyabi-Hauz square",
          "Day 7: Bukhara — Chor Minor, Trading Domes, evening flight back",
        ],
        10: [
          "Day 1–2: Tashkent — Metro, Chorsu, museum, old city",
          "Day 3–5: Samarkand — Registan, Shah-i-Zinda, Observatory, Night Show",
          "Day 6–7: Bukhara — Old city, Ark, Lyabi-Hauz, Ismail Samani",
          "Day 8–10: Khiva — Ichan Kala, Kalta Minor, Toshhovli Palace",
        ],
        14: [
          "Day 1–3: Tashkent — Deep metro, museum, old town, Navruz (if March)",
          "Day 4–6: Samarkand — All sights, Siab Bazaar, day trip to Shakhrisabz",
          "Day 7–9: Bukhara — Full old city exploration, hammam, cooking class",
          "Day 10–12: Khiva — Ichan Kala walls, all palaces, sunset views",
          "Day 13–14: Return via Tashkent — last meals, bazaar shopping",
        ],
      },
    },
    photo: {
      ...
      routes: {
        7: [
          "Day 1: Tashkent Metro (each station unique — shoot all day)",
          "Day 2–3: Samarkand — Registan at sunrise, Shah-i-Zinda at golden hour",
          "Day 4: Samarkand — Siab Bazaar portraits, Bibi-Khanym at noon",
          "Day 5–7: Bukhara — Kalon at night, Lyabi-Hauz reflections, old alleys",
        ],
        10: [
          "Day 1: Tashkent — Metro architecture, Chorsu Bazaar portraits",
          "Day 2–4: Samarkand — Registan sunrise, Night Show, Shah-i-Zinda light",
          "Day 5: Bibi-Khanym, Siab market, Amir Temur statue at dusk",
          "Day 6–8: Bukhara — Kalon lit at night, Chor Minor, Ark ramparts",
          "Day 9–10: Khiva — Kalta Minor blue tiles, rooftop sunrise view",
        ],
        14: [
          "Day 1–2: Tashkent Metro deep dive + Chorsu portraits",
          "Day 3–5: Samarkand — All angles, Night Show, dawn at Registan alone",
          "Day 6–7: Shakhrisabz (Tamerlane's birthplace) — stunning ruins",
          "Day 8–10: Bukhara — Night shots, bazaar life, artisan workshops",
          "Day 11–14: Khiva — The most photogenic city in Central Asia",
        ],
      },
    },
    food: {
      ...
      routes: {
        7: [
          "Day 1: Tashkent — Chorsu plov at 10am, Besh Qozon for lunch",
          "Day 2: Tashkent — Noorani Indian, evening at Amir Temur with snacks",
          "Day 3–4: Samarkand — Emirhan rooftop, Shokhrukh Nur shashlik, The Mohon",
          "Day 5–7: Bukhara — JOY Gastro, Zaytoon Lebanese, Lyabi-Hauz teahouse",
        ],
        10: [
          "Day 1–2: Tashkent — Full food tour: Chorsu, Pro.Khinkali, CZN Burak",
          "Day 3–5: Samarkand — The Mohon, Boulevard breakfast, Siab Bazaar snacks",
          "Day 6: Samarkand cooking class — learn to make plov from scratch",
          "Day 7–9: Bukhara — Ayvan terrace, JOY with live music, Zaytoon",
          "Day 10: Khiva — Simple local food inside the walled city",
        ],
        14: [
          "Day 1–3: Tashkent — Full food city deep dive, all best restaurants",
          "Day 4–6: Samarkand — Every recommended restaurant, market tastings",
          "Day 7: Samarkand plov master class",
          "Day 8–10: Bukhara — All restaurants, Navruz sweets, wine tasting",
          "Day 11–14: Khiva — Local family dining, Khorezm-style specialties",
        ],
      },
    },
  };
  ...
  const generateRoute = () => {
    ...
    setRouteResult({
      style: itinerary.label,
      icon: itinerary.icon,
      days: tripDays,
      route: itinerary.routes[dayKey],
    });
  };
        ...
        <div style={{ animation: "fadeUp 0.3s ease" }}>
          ...
          {activeSection === "itinerary" && (
            <div>
              ...
              >
                Tell us your travel style and trip length — we'll build a
                personalized day-by-day route
              </p>
                        ...
                        style={{
                          ...
                          background:
                            tripDays === d
                              ...
                              : "transparent",
                          border: `1px solid ${
                            tripDays === d ? "#C9A84C" : "#2A2418"
                          }`,
                          borderRadius: 24,
                          color: tripDays === d ? "#C9A84C" : "#5A4E3A",
                          fontFamily: "'Cinzel',serif",
                          fontSize: 12,
                          cursor: "pointer",
                          transition: "all 0.2s",
                        ...
                        style={{
                          ...
                          background:
                            tripStyle === key
                              ...
                              : "transparent",
                          border: `1px solid ${
                            tripStyle === key ? "#C9A84C" : "#2A2418"
                          }`,
                          borderRadius: 24,
                          color: tripStyle === key ? "#C9A84C" : "#5A4E3A",
                          fontFamily: "'Cinzel',serif",
                          fontSize: 11,
                          cursor: "pointer",
                          transition: "all 0.2s",
              ...
              {routeResult && (
                ...
                >
                  ...
                  >
                    {routeResult.icon} {routeResult.style.toUpperCase()} ·{" "}
                    {routeResult.days} DAYS
                  </div>
                  ...
                  >
                    ...
                    >
                      (bottom-right button) to customize this route, add
                      restaurant recommendations, or plan transport between each
                      city.
                    </span>
                  </div>
                </div>
